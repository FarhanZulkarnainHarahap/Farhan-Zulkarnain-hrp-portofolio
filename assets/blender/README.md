...
Current Project devices are generated by `scripts/blender/create_fzh_devices.py`. See the [device family audit and pipeline](../../docs/FZH_Kinetic_Device_Showcase_README.md).
