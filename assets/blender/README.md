...
Asset 04 replaces the Project browser preview with a reusable mechanical capsule and structural rail. See [Project Vault documentation](../../docs/FZH_Project_Artifact_README.md).
