  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 lg:flex lg:w-max">
        ...
        <section id="skills" className="portfolio-section-bg mx-auto w-full max-w-7xl px-6 py-20 md:px-12 md:py-24 lg:flex lg:h-screen lg:w-screen lg:max-w-none lg:shrink-0 lg:snap-center lg:flex-col lg:justify-center lg:overflow-hidden lg:px-16">
