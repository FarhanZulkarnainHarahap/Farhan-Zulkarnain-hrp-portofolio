...
export default function HeroCard() {
  ...
  return (
    <section className="relative flex min-h-[100svh] w-full items-center justify-center bg-transparent pb-40 pt-16 sm:pb-40 sm:pt-20 md:pb-44 lg:h-screen lg:overflow-hidden lg:py-0">
